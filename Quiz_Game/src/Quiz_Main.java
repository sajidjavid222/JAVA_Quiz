//NAME : SAJID JAVID
//FACULTY NUMBER : 20COB004
//ENROLMENT NUMBER : GL9505
...
class Quiz implements ActionListener{
    ...
    String[] questions = { 
                            "What is your name?",
                            "What is your Faculty Number?",
                            "Where are you from?",
                            "Who is your Faculty In-charge for OOPs?"
                         };
    
    //Options for the Quiz
    String[][] options = {
                            { "Sajid Javid" , "Mohammad Mamoon", "Mohammad Saim", "Ilma Shah"},
                            { "20MEB004", "20C0B004", "20CEB004", " 20ELB0004"},
                            { "Kashmir", "Aligarh", "Mirzapur", "Delhi"},
                            { "Prof. M.M. Sufiyan Beg", "Mr. Syed Usman Ahmad", "Prof Saiful Islam", "Prof. Nadeem Akhter"}
                          };
    ...
    public Quiz(){
        ...
        answer_labelA.setBackground(new Color(64,64,64));
        ...
        answer_labelB.setBackground(new Color(64,64,64));
        ...
        answer_labelC.setBackground(new Color(64,64,64));
        ...
        answer_labelD.setBackground(new Color(64,64,64));
    ...
    public void displayAnswer(){
      ...
      Timer pause = new Timer(2500, new ActionListener(){
        @Override
        public void actionPerformed(ActionEvent e){
          //changing the colours back to green
          answer_labelA.setForeground(new Color(25,255,0));
          answer_labelB.setForeground(new Color(25,255,0));
          answer_labelC.setForeground(new Color(25,255,0));
          answer_labelD.setForeground(new Color(25,255,0));
    ...
    public void results(){
      ...
      textarea.setText("YOUR RESULTS ARE PROVIDED BELOW : ");
